...
#'
#' # the MGSEA.res1 uses the weighted multiple linear regression to do permutation test, while MGSEA.res2 used the solution of weighted matrix operation. The latter one takes substantially less time.
