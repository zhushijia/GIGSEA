#' permutationSingleLm
#'
#' permutationSingleLm is a permutation test to calculate the empirical p values for a single weighted linear regression.
#'
...
#' \item {observedPval} a vector of numeric values [0,1] indicating the p values from single weighted regression model.
...
#' @references
#'
#' @seealso \code{\link{orderedIntersect}}; \code{\link{permutationSingleLmMatrix}};
#'
permutationSingleLm = function( fc , net , weights=rep(1,nrow(net)) , num=100 )
{
