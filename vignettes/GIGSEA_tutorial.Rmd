...
### 5.1 Gene set enrichment analysis using single-variate weighted regression model
...
### 5.2 Gene set enrichment analysis using multi-variate weighted regression model
...
# run one-step GIGSEA 
weightedGSEA(data, geneCol='gene', fcCol='fc', weightCol= 'weights', geneSet=c("MSigDB.KEGG.Pathway","MSigDB.TF","MSigDB.miRNA","Fantom5.TF","TargetScan.miRNA","GO","LINCS.CMap.drug"), permutationNum=10000, outputDir="./GIGSEA" )
dir("./GIGSEA")
```
