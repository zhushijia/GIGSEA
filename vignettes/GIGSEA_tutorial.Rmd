...
Alternatively, users can also submit their GWAS summary data to the online version of MetaXcan <https://cloud.hakyimlab.org/s-predixcan> to impute the trait-associated differential gene expression, and next, run the following steps provided by GIGSEA to perform the gene set enrichment analysis for the trait-associated SNPs. 
