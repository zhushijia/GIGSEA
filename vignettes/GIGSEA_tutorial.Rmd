...
<<<<<<< HEAD
In case that users have not installed MetaXcan yet, an example of MetaXcan-imputed gene expression is given as follows. Users can use it to test the codes of GIGSEA step by step. 
=======
`In case that users have not installed MetaXcan yet, an example of MetaXcan-imputed gene expression is given as follows. Users can use it to test the codes of GIGSEA step by step.` 
>>>>>>> f0bfd41c2f6aca9919ee124209e2bb92b186d701
