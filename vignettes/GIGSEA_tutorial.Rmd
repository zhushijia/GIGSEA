...
- `Fantom5.TF`: Gene sets of predicted human transcriptional factor (TF) target sites were downloaded from Fantom5. The dataset contains 500 WMs. For each WM, there is an ordered list of associated human TFs, ordered by percent identity of TFs known to bind sites of the WM. The list of associations was checked manually. The entire set of WMs and mapping to associated TFs is available from the SwissRegulon website <http://www.swissregulon.unibas.ch>.
