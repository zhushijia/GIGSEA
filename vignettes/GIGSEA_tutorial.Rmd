...
addresses such challenges for SNP enrichment as gene size, gene boundary, and
multiple-marker regulation. The weighted linear regression model, taking as 
...
sets. The permutation test, furthermore, is used to evaluate the significance of
enrichment, whose efficiency can be largely elevated by expressing the 
